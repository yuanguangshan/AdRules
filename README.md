...
## 规则总数
```
更新时间: 2022-04-03 10:19:23 （北京时间） 

AdRules（For AdBlock）规则数量: 88892 

AdRules（For AdGuard）规则数量: 106697 

AdRules（For DNS）规则数量: 86232 

AdRules（For Adaway）规则数量: 82176 

AdRules Allowlist 规则数量: 16992 

AdRules Ad Domains List 数量: 82176 

AdRules AdBlock Full List 规则数量: 237423 
