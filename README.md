...
## 规则总数
```
更新时间: 2022-03-22 00:51:00 （北京时间） 

AdRules（For AdBlock）规则数量: 127635 

AdRules（For AdGuard）规则数量: 103729 

AdRules（For DNS）规则数量: 103840 
...
AdRules AdBlock Full List 规则数量: 233240 

AdRules AdGuard Full List 规则数量: 183391 
``` 
## 说明
