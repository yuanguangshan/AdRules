...
## 规则总数
```
更新时间: 2022-03-28 20:56:24 （北京时间） 

AdRules（For AdBlock）规则数量: 97122 

AdRules（For AdGuard）规则数量: 102762 

AdRules（For DNS）规则数量: 87042 

AdRules（For Adaway）规则数量: 85010 

AdRules Allowlist 规则数量: 17464 

AdRules Ad Domans List 数量: 102001 

AdRules AdBlock Full List 规则数量: 238603 

AdRules AdGuard Full List 规则数量: 183026 
``` 
## 说明
